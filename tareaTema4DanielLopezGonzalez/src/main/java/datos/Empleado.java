...
public class Empleado extends Trabajador{
    ...
    public Empleado() {
       categoria = ConstantesAlmacen.NUMERO_CATEGORIA_EMPLEADO;
    }
    
    /*Constructor con super() que inicializa las variables de la clase superior*/
    public Empleado(String nombre, int edad, int antiguedad, Fecha fecha_alta) {
 ...
 @Override
    public double sueldoTrabajador(int antiguedad) {
        ...
        calculoSueldo = ConstantesAlmacen.SUELDO_BASE + (ConstantesAlmacen.SUELDO_BASE * ConstantesAlmacen.IMPCAT_EMPLEADO) + importeAntiguedad;
