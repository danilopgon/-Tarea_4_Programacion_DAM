...
public class Encargado extends Trabajador{
    ...
    public Encargado() {
        categoria = ConstantesAlmacen.NUMERO_CATEGORIA_ENCARGADO;
    }
    
    /*Constructor con super() que inicializa las variables de la clase superior*/
    public Encargado (String nombre, int edad, int antiguedad, Fecha fecha_alta) {
 ...
 @Override
    public double sueldoTrabajador(int antiguedad) {
        ...
        calculoSueldo = ConstantesAlmacen.SUELDO_BASE + (ConstantesAlmacen.SUELDO_BASE * ConstantesAlmacen.IMPCAT_ENCARGADO) + importeAntiguedad;
