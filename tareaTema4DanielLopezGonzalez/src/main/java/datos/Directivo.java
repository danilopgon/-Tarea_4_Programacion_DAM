...
public class Directivo extends Trabajador{
    ...
    public Directivo() {
        categoria = ConstantesAlmacen.NUMERO_CATEGORIA_DIRECTIVO;
    }
    
    /*Constructor con super() que inicializa las variables de la clase superior*/
    public Directivo (String nombre, int edad, int antiguedad, Fecha fecha_alta) {
  ...
  @Override
   public String nombreCategoria () {
    ...
    public double sueldoTrabajador(int antiguedad) {
        ...
        calculoSueldo = ConstantesAlmacen.SUELDO_BASE + (ConstantesAlmacen.SUELDO_BASE * ConstantesAlmacen.IMPCAT_DIRECTIVO) + importeAntiguedad;
